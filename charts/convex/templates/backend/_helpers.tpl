...
{{- default (print .Chart.Name "-backend") .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- else }}
{{- $name := default (print .Chart.Name "-backend") .Values.nameOverride }}
...
{{- default (include "convex.backend.fullname" .) .Values.serviceAccount.name }}
{{- else }}
